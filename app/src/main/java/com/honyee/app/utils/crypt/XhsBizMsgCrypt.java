...
public class XhsBizMsgCrypt {
     ...
     * @param encrypt     密文，推送数据中的encrypt字段
     * @return 解密后的原文
     */
    public String decrypt(String appid, String messageValidToken, String messageEncodeDecodeKey,
        ...
        // 验证安全签名
        BizMsgCryptUtil.verify(messageValidToken, msgSignature, timestamp, nonce, encrypt);
        // 解密
        return BizMsgCryptUtil.decrypt(appid, encrypt, messageEncodeDecodeKey, RANDOM_BYTES_POS);
    }
