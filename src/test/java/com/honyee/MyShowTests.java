...
import com.honyee.dto.CitySimpleDTO;
import com.honyee.enums.StateEnum;
import com.honyee.mapper.CityMapper;
import com.honyee.mapper.ProductMapper;
import com.honyee.model.City;
...
public class MyShowTests {
    ...
    void queryCity() {
        ...
        List<CitySimpleDTO> objects = sqlSession.selectList("com.honyee.mapper.CityMapper.findSimple", city, new RowBounds(ROW_BOUNDS_START, PAGE_SIZE));
